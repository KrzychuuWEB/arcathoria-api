...
public class ParticipantNotFoundInCombatDomainException extends CombatDomainException {

    private final CombatId combatId;
    private final ParticipantId participantId;

    public ParticipantNotFoundInCombatDomainException(final CombatId combatId, final ParticipantId participantId) {
