...
public enum CombatExceptionErrorCode implements DomainErrorCode {
    ...
    ERR_COMBAT_ACTION_TYPE_NOT_FOUND(DomainExceptionCodeCategory.NOT_FOUND),
    ERR_COMBAT_PARTICIPANT_NOT_FOUND_IN_COMBAT(DomainExceptionCodeCategory.NOT_FOUND),
    ERR_ONLY_ONE_ACTIVE_COMBAT(DomainExceptionCodeCategory.CONFLICT),
    ...
    ERR_COMBAT_PARTICIPANT_NOT_AVAILABLE(DomainExceptionCodeCategory.NOT_FOUND);
