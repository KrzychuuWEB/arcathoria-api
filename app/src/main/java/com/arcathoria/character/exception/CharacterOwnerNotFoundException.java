...
public class CharacterOwnerNotFoundException extends CharacterApplicationException implements UpstreamAware {

    private final UpstreamInfo upstreamInfo;

    public CharacterOwnerNotFoundException(final AccountId accountId, final UpstreamInfo upstreamInfo) {
